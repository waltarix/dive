...
func (vm *FileTree) GotoLastLine() bool {
	visibleSize := vm.ModelTree.VisibleSize()
...
func (vm *FileTree) ToFirstLine() bool {
	if vm.bufferIndex == 0 {
		return false
	}
...
func (vm *FileTree) ToMiddleLine() bool {
	visibleSize := vm.ModelTree.VisibleSize()
...
func (vm *FileTree) ToLastLine() bool {
	visibleSize := vm.ModelTree.VisibleSize()
