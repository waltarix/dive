...
func initConfig() {
	...
	viper.SetDefault("keybinding.toggle-wrap-tree", "ctrl+t")
	viper.SetDefault("keybinding.page-up", "pgup")
	viper.SetDefault("keybinding.page-down", "pgdn")
	// keybindings: vim like
	viper.SetDefault("keybinding.x-up", "k")
	viper.SetDefault("keybinding.x-down", "j")
	viper.SetDefault("keybinding.x-left", "h")
	viper.SetDefault("keybinding.x-right", "l")
